            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-header">
                        ...
                        <button class="layui-btn" onclick="xadmin.open('添加用户','{{ route('materials_record.create') }}',600,400)"><i
                        ...
                        <table class="layui-table layui-form">
                            ...
                            @foreach ($records as $record)
                                <tr>
                                    ...
                                    <td class="td-manage">
                                        <a title="编辑" onclick="xadmin.open('编辑', '{{ route('materials_record.edit', $record->id) }}',600,400)" href="javascript:;">
                                            <i class="layui-icon">&#xe642;</i>
                                        </a>
                                        <a title="删除" onclick="member_del(this,'{{ route('materials_record.destroy', $record->id) }}')" href="javascript:;">
                                            <i class="layui-icon">&#xe640;</i>
                                        </a>
                                    </td>
                                </tr>
